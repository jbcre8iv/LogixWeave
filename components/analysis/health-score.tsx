        ...
        <div className="flex flex-col sm:flex-row items-center gap-8">
          ...
          <div className="flex flex-col items-center flex-shrink-0">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center whitespace-nowrap mt-3 h-9 px-4 text-sm font-medium rounded-md bg-amber-500 text-white hover:bg-amber-600 transition-colors"
            >
